...
md['genres'] = md['genres'].fillna('[]').apply(literal_eval).apply(lambda x: [i[
                                                                                  'name'] for i in x] if isinstance(x,
                                                                                                                    list) else [])
...
tf = TfidfVectorizer(analyzer='word', ngram_range=(1, 2), min_df=0.00001, stop_words='english')
...
count = CountVectorizer(analyzer='word', ngram_range=(1, 2), min_df=0.0001, stop_words='english')
