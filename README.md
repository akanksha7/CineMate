...
```
cd existing_repo
git remote add origin https://code.vt.edu/sabrinahart/ai_mini_project.git
git branch -M main
...
- [ ] [Set up project integrations](https://code.vt.edu/sabrinahart/ai_mini_project/-/settings/integrations)
